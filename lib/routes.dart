...
import 'pages/notificacao/notificacoes_page.dart'; // Import da nova página
  ...
  static Map<String, WidgetBuilder> getRoutes() {
    return {
      ...
      home: (context) {
        ...
        print("DEBUG: Tentando acessar HOME com args: $args"); // Adicione isso!
      ...
      indicadores: (context) {
        final args = ModalRoute.of(context)?.settings.arguments;
        return args is Usuario ? const IndicadoresPage() : const LoginPage();
      },
      chamados: (context) {
        final args = ModalRoute.of(context)?.settings.arguments;
